...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-sm-12">
            <h2><asp:Literal runat="server" Text="<%$Resources:general,Machine %>"></asp:Literal></h2>
            <div class="table-responsive">
                <asp:GridView ID="MachineGridView" runat="server" DataKeyNames="id_machine" AutoGenerateColumns="false" AllowPaging="true" PageSize="25" OnRowDeleting="GridView_RowDeleting" OnRowEditing="GridView_RowEditing" OnRowCancelingEdit="GridView_RowCancelingEdit" OnRowUpdating="GridView_RowUpdating" CssClass="table table-striped">
                    <Columns>
                        <asp:BoundField DataField="id_machine" ReadOnly="true" HeaderText="<%$Resources:general,ID %>" />
            <asp:TemplateField HeaderText="<%$Resources:general,Brand %>">  
                <EditItemTemplate>  
                    <asp:TextBox ID="marque_Text" runat="server" Text='<%# Bind("marque") %>'></asp:TextBox>  
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="marque_Validator" runat="server" ControlToValidate="marque_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldBrandCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="<%$Resources:general,ModelNumber %>">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="modele_Validator" runat="server" ControlToValidate="modele_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldModelCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="<%$Resources:general,Height %>">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="hauteur_Validator" runat="server" ControlToValidate="hauteur_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldHeightCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="hauteur_RegValidator"  ControlToValidate="hauteur_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="<%$Resources:general,Width %>">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="largeur_Validator" runat="server" ControlToValidate="largeur_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheWidthFieldCannotBeEmpty %>"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="largeur_RegValidator"  ControlToValidate="largeur_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
                    <asp:Label ID="largeur_Label" runat="server" Text='<%# Bind("largeur") %>'></asp:Label>  
                </ItemTemplate>  
            </asp:TemplateField>      
            <asp:TemplateField HeaderText="<%$Resources:general,Weight %>">  
                <EditItemTemplate>  
                    <asp:TextBox ID="poids_Text" runat="server" Text='<%# Bind("poids") %>'></asp:TextBox>  
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="poids_Validator" runat="server" ControlToValidate="poids_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldWeightCannotBeEmpty %>"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="poids_RegValidator"  ControlToValidate="poids_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
                    <asp:Label ID="poids_Label" runat="server" Text='<%# Bind("poids") %>'></asp:Label>  
                </ItemTemplate>  
            </asp:TemplateField>
            <asp:TemplateField HeaderText="<%$Resources:general,Capacity %>">  
                <EditItemTemplate>  
                    <asp:TextBox ID="capacite_Text" runat="server" Text='<%# Bind("capacite") %>'></asp:TextBox>  
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="capacite_Validator" runat="server" ControlToValidate="capacite_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldCapacityCannotBeEmpty %>"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="capacite_RegValidator"  ControlToValidate="capacite_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="<%$Resources:general,NumberOfHoursOfMaintenance %>">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="nb_heure_entre_entretient_Validator" runat="server" ControlToValidate="nb_heure_entre_entretient_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheWidthFieldCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="nb_heure_entre_entretient_RegValidator"  ControlToValidate="nb_heure_entre_entretient_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="<%$Resources:general,CompatibilityType %>">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="type_compatibilite_Validator" runat="server" ControlToValidate="type_compatibilite_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldCompatibilityTypeCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
    ...
    <div class="row">
        <div class="col-sm-12">
            <h2><asp:Literal runat="server"  Text="<%$Resources:general,AddAMachine %>"></asp:Literal></h2>
            <div class="form form-horizontal">
                ...
                <div class="form-group">
                    <label for="addPoidText" class="col-sm-2 control-label"><asp:Literal runat="server"  Text="<%$Resources:general,Weight_InKilograms %>"></asp:Literal></label>
                    <div class="col-sm-10">
                        <asp:TextBox id="addPoidText" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ValidationGroup="Add" ID="addPoid_Validator" Display="Dynamic" runat="server" ControlToValidate="addPoidText" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldWeightCannotBeEmpty %>"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ValidationGroup="Add" id="addPoid_RegValidator" Display="Dynamic" ControlToValidate="addPoidText" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label for="addCapaciteText" class="col-sm-2 control-label"><asp:Literal runat="server"  Text="<%$Resources:general,Capacity_InKilograms %>"></asp:Literal></label>
                    <div class="col-sm-10">
                        <asp:TextBox id="addCapaciteText" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ValidationGroup="Add" ID="addCapacite_Validator" Display="Dynamic" runat="server" ControlToValidate="addCapaciteText" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldCapacityCannotBeEmpty %>"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ValidationGroup="Add" id="addCapacite_RegValidator" Display="Dynamic" ControlToValidate="addCapaciteText" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="<%$Resources:general,CanOnlyContainNumbers %>" runat="server"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                       ...
                       <asp:RequiredFieldValidator ValidationGroup="Add" ID="addCompatibilite_Validator" Display="Dynamic" runat="server" ControlToValidate="addCompatibiliteText" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldCompatibilityCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                    </div>
                </div>
                <div class="form-group">
