        ...
        <div class="col-sm-12">
            ...
            <asp:TemplateField HeaderText="Numéro Attachement">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="numero_attachement_Validator" Display="Dynamic" runat="server" ControlToValidate="numero_attachement_Text" ForeColor="Red" ErrorMessage="Le champ Numéro attachement ne peut être vide."></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Numéro de Série">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="numero_serie_Validator" Display="Dynamic" runat="server" ControlToValidate="numero_serie_Text" ForeColor="Red" ErrorMessage="Le champ Numéro de série ne peut être vide."></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Type de compatibilité">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="type_compatibilite_Validator" Display="Dynamic" runat="server" ControlToValidate="type_compatibilite_Text" ForeColor="Red" ErrorMessage="Le champ Type de compatibilité ne peut être vide."></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Marque">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="marque_Validator" Display="Dynamic" runat="server" ControlToValidate="marque_Text" ForeColor="Red" ErrorMessage="Le champ Marque ne peut être vide."></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Numéro Modèle">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="modele_Validator" Display="Dynamic" runat="server" ControlToValidate="modele_Text" ForeColor="Red" ErrorMessage="Le champ Numéro Modèle ne peut être vide."></asp:RequiredFieldValidator>  
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Hauteur">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="hauteur_Validator" Display="Dynamic" runat="server" ControlToValidate="hauteur_Text" ForeColor="Red" ErrorMessage="Le champ Hauteur ne peut être vide."></asp:RequiredFieldValidator>  
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="hauteur_RegValidator"  Display="Dynamic" ControlToValidate="hauteur_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="Ne peut contenir que des nombres" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Largeur">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="largeur_Validator" Display="Dynamic" runat="server" ControlToValidate="largeur_Text" ForeColor="Red" ErrorMessage="Le champ Largeur ne peut être vide."></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="largeur_RegValidator"  Display="Dynamic" ControlToValidate="largeur_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="Ne peut contenir que des nombres" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
            ...
            <asp:TemplateField HeaderText="Nombre d'heure d'entretien">  
                <EditItemTemplate>  
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="Update" ID="nb_heure_entre_entretient_Validator" Display="Dynamic" runat="server" ControlToValidate="nb_heure_entre_entretient_Text" ForeColor="Red" ErrorMessage="Le champ Largeur ne peut être vide."></asp:RequiredFieldValidator>  
                    <asp:RegularExpressionValidator ValidationGroup="Update" id="nb_heure_entre_entretient_RegValidator"  Display="Dynamic" ControlToValidate="nb_heure_entre_entretient_Text" ValidationExpression="^\d+" ForeColor="Red" ErrorMessage="Ne peut contenir que des nombres" runat="server"></asp:RegularExpressionValidator>
                </EditItemTemplate>  
                <ItemTemplate>  
        ...
        <div class="col-sm-12">
            ...
            <div class="form form-horizontal">
                <div class="form-group">
                    <label for="addNumAttachementText" class="col-sm-2 control-label">Numero d'attachement</label>
                    <div class="col-sm-10">
                        <asp:TextBox id="addNumAttachementText" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ValidationGroup="Add" ID="addNumAttachement_Validator" Display="Dynamic" runat="server" ControlToValidate="addNumAttachementText" ForeColor="Red" ErrorMessage="Le champ Numéro d'attachement ne peut être vide."></asp:RequiredFieldValidator>  
                    </div>
                </div>
                <div class="form-group">
                    <label for="addNumSerieText" class="col-sm-2 control-label">Numero de Série</label>
                    <div class="col-sm-10">
                        <asp:TextBox id="addNumSerieText" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ValidationGroup="Add" ID="addNumSerie_Validator" Display="Dynamic" runat="server" ControlToValidate="addNumSerieText" ForeColor="Red" ErrorMessage="Le champ Numéro de Série ne peut être vide."></asp:RequiredFieldValidator>  
                    </div>
                </div>
                <div class="form-group">
