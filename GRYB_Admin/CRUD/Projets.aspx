...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-sm-12">
            <h2><asp:Literal runat="server" Text="<%$Resources:general,Project %>"></asp:Literal></h2>
            <div class="table-responsive">
                <asp:GridView ID="ProjectGridView" runat="server" DataKeyNames="id_projet" AutoGenerateColumns="false" AllowPaging="true" PageSize="25" OnRowDeleting="GridView_RowDeleting" OnRowEditing="GridView_RowEditing" OnRowCancelingEdit="GridView_RowCancelingEdit" OnRowUpdating="GridView_RowUpdating" CssClass="table table-striped">
                    <Columns>
                    <asp:BoundField DataField="id_projet" ReadOnly="true" HeaderText="<%$Resources:general,ID %>" />
                    <asp:TemplateField HeaderText="<%$Resources:general,Name %>">  
                            <EditItemTemplate>  
                                <asp:TextBox ID="name_Text" runat="server" Text='<%# Bind("nom") %>'></asp:TextBox>  
                                <asp:RequiredFieldValidator ValidationGroup="Update" Display="Dynamic" ID="name_Validator" runat="server" ControlToValidate="name_Text" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldNameCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                            </EditItemTemplate>  
                            <ItemTemplate>  
            ...
            <div class="form form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="Add" ID="addName_Validator" Display="Dynamic" runat="server" ControlToValidate="addNameText" ForeColor="Red" ErrorMessage="<%$Resources:general,TheFieldNameCannotBeEmpty %>"></asp:RequiredFieldValidator>  
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-1 col-sm-11">
                        <asp:Button ValidationGroup="Add" runat="server" ID="Add" CssClass="btn btn-primary" Text="<%$Resources:general,Add %>" OnClick="insert" />
                    </div>
                </div>
            </div>
        </div>
